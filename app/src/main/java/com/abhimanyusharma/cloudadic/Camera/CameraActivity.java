package com.abhimanyusharma.cloudadic.Camera;
...
public class CameraActivity extends Activity implements SurfaceHolder.Callback, Camera.ShutterCallback, Camera.PictureCallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        switchCam= (Button) findViewById(R.id.button1);
        findViewById(R.id.button2).getBackground().setLevel(1);
        findViewById(R.id.button1).getBackground().setLevel(2);
    }
